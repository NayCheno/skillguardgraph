...
- A passive real public measurement over 1,000 public MCP artifacts (600 GitHub repositories, 250 npm packages, and 150 Hugging Face Spaces) is included with a data card and manual triage of all HIGH findings.
