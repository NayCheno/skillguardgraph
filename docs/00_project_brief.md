...
- A passive real public measurement over 1,000 public MCP artifacts (400 GitHub repositories, 200 npm packages, 150 discovered PyPI packages, 150 Hugging Face Spaces, and 100 Smithery hosted-registry entries) is included with a data card, an official-advisory cross-check, and manual triage of all HIGH findings, alongside supplementary 2k/3k/5k/10k scale-out catalog batches.
