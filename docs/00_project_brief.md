...
- A passive real public measurement over 1,000 public MCP artifacts (630 GitHub repositories, 200 npm packages, 20 curated PyPI packages, and 150 Hugging Face Spaces) is included with a data card and manual triage of all HIGH findings.
