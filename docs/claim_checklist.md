...
| Third-party dynamic sandbox beyond bounded public-package/repo/TypeScript cases | Isolated execution of non-toy external skills at arbitrary package / marketplace breadth |
