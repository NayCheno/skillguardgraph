...
6. `docs/claim_checklist.md`, `docs/mock_review.md`, and `docs/rebuttal_bank.md` — submission- and review-facing claim audit material.
...
| Review and submission | `docs/claim_checklist.md`, `docs/mock_review.md`, `docs/rebuttal_bank.md` | Claim-to-evidence audit, mock review notes, and rebuttal material. |
