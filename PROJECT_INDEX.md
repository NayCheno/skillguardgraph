...
6. `docs/claim_checklist.md`, `docs/mock_review.md`, `docs/rebuttal_bank.md`, and `docs/review_response_strategy.md` — submission- and review-facing claim audit material.
7. `checklists/acceptance_checklist.md` — final acceptance gate.
8. `artifact/README.md` and `artifact/EXPECTED_OUTPUTS.md` — reproduction and expected outputs.
9. `paper/main.tex` and `paper/appendix.tex` — paper draft.
...
| Review and submission | `docs/claim_checklist.md`, `docs/mock_review.md`, `docs/rebuttal_bank.md`, `docs/review_response_strategy.md` | Claim-to-evidence audit, mock review notes, rebuttal material, and reviewer-handling strategy. |
